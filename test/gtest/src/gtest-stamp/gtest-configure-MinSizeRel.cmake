...
if(result)
  ...
  if (${log_merged})
    ...
    set(msg "${msg}\nSee also\n  C:/Users/Gearing/Documents/GitHub/SOFT356-Ben-Gearing/test/gtest/src/gtest-stamp/gtest-configure-*.log")
  endif()
  ...
  set(msg "gtest configure command succeeded.  See also C:/Users/Gearing/Documents/GitHub/SOFT356-Ben-Gearing/test/gtest/src/gtest-stamp/gtest-configure-*.log")
  message(STATUS "${msg}")
endif()
